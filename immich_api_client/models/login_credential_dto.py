...
class LoginCredentialDto(BaseModel):
    ...
    LoginCredentialDto
    """ # noqa: E501
    email: Annotated[str, Field(strict=True)] = Field(description="User email", json_schema_extra={"examples": ["testuser@email.com"]})
    ...
    def email_validate_regular_expression(cls, value):
        ...
        if isinstance(value, str) and not re.match(r"^[a-zA-Z0-9.!#$%&\'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$", value):
