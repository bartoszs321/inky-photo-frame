...
class SmartSearchDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["albumIds", "city", "country", "createdAfter", "createdBefore", "isEncoded", "isFavorite", "isMotion", "isNotInAlbum", "isOffline", "language", "lensModel", "libraryId", "make", "model", "ocr", "page", "personIds", "query", "queryAssetId", "rating", "size", "state", "tagIds", "takenAfter", "takenBefore", "trashedAfter", "trashedBefore", "type", "updatedAfter", "updatedBefore", "visibility", "withDeleted", "withExif"]
